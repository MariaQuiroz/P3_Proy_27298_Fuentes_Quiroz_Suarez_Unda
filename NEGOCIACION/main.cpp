...
int main() {
    ...
    // ==========================================
    // PARTE 3: NEGOCIACIÓN SALARIAL
    // ==========================================
    cout << "\n=== MODULO 3: NEGOCIACION SALARIAL ===" << endl;

    // Usamos el valor de mercado como oferta inicial
    float ofertaInicial = static_cast<float>(valorMercado);

    ControladorNegociacion controlador(ofertaInicial);
    controlador.iniciarNegociacion();
